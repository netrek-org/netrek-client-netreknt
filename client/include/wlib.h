...
#ifdef WIN32
extern W_Icon W_StoreBitmap2 (HINSTANCE hLibInstance, int width, int height, int data, W_Window window, UINT BmpType);
extern W_Icon W_PointBitmap2 (W_Icon bigbitmap, int col, int row, int width, int height);
#endif
