...
void mapWaitWin(W_Window waitWin)
{
  char   *s;
  char    buf[60];
...
void mapWaitQuit(W_Window qwin)
{
  char   *s = "Quit";
...
void mapWaitCount(W_Window waitWin, W_Window countWin, int count)
{
  char   *s1 = "Wait";
  char   *s2 = "Queue";
  char    buf[80];
...
void mapWaitMotdButton(W_Window motdButtonWin)
{
  char   *s = "Motd";
